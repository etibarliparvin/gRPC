...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/transfer-service.proto")
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<az.etibarli.grpc.TransferRequest,
      az.etibarli.grpc.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = az.etibarli.grpc.TransferRequest.class,
      responseType = az.etibarli.grpc.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<az.etibarli.grpc.TransferRequest,
      az.etibarli.grpc.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<az.etibarli.grpc.TransferRequest, az.etibarli.grpc.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<az.etibarli.grpc.TransferRequest, az.etibarli.grpc.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.TransferResponse.getDefaultInstance()))
  ...
  public static abstract class TransferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<az.etibarli.grpc.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<az.etibarli.grpc.TransferResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                az.etibarli.grpc.TransferRequest,
                az.etibarli.grpc.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return az.etibarli.grpc.TransferServiceOuterClass.getDescriptor();
    }
