...
@javax.annotation.Generated(
    ...
    comments = "Source: ticket/agent.proto")
public final class AgentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.ticket.AgentRequest,
      com.proto.ticket.AgentResponse> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = com.proto.ticket.AgentRequest.class,
      responseType = com.proto.ticket.AgentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.ticket.AgentRequest,
      com.proto.ticket.AgentResponse> getSendMethod() {
    io.grpc.MethodDescriptor<com.proto.ticket.AgentRequest, com.proto.ticket.AgentResponse> getSendMethod;
      ...
      synchronized (AgentServiceGrpc.class) {
        if ((getSendMethod = AgentServiceGrpc.getSendMethod) == null) {
          AgentServiceGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<com.proto.ticket.AgentRequest, com.proto.ticket.AgentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.ticket.AgentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.ticket.AgentResponse.getDefaultInstance()))
  ...
  public static abstract class AgentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(com.proto.ticket.AgentRequest request,
        io.grpc.stub.StreamObserver<com.proto.ticket.AgentResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.proto.ticket.AgentRequest,
                com.proto.ticket.AgentResponse>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class AgentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AgentServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.ticket.AgentResponse send(com.proto.ticket.AgentRequest request) {
  ...
  public static final class AgentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AgentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.ticket.AgentResponse> send(
        com.proto.ticket.AgentRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((com.proto.ticket.AgentRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.ticket.AgentResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AgentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.ticket.Agent.getDescriptor();
    }
