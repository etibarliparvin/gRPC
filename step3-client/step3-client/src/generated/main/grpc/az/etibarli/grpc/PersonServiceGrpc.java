...
public final class PersonServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<az.etibarli.grpc.PersonRequest,
      az.etibarli.grpc.PersonResponse> getGetPeopleMethod;
  ...
  public static io.grpc.MethodDescriptor<az.etibarli.grpc.PersonRequest,
      az.etibarli.grpc.PersonResponse> getGetPeopleMethod() {
    io.grpc.MethodDescriptor<az.etibarli.grpc.PersonRequest, az.etibarli.grpc.PersonResponse> getGetPeopleMethod;
    if ((getGetPeopleMethod = PersonServiceGrpc.getGetPeopleMethod) == null) {
      synchronized (PersonServiceGrpc.class) {
        if ((getGetPeopleMethod = PersonServiceGrpc.getGetPeopleMethod) == null) {
          PersonServiceGrpc.getGetPeopleMethod = getGetPeopleMethod =
              ...
              .setSchemaDescriptor(new PersonServiceMethodDescriptorSupplier("getPeople"))
              .build();
        }
      }
    }
  ...
  public static abstract class PersonServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getPeople(az.etibarli.grpc.PersonRequest request,
  ...
  public static final class PersonServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PersonServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<az.etibarli.grpc.PersonResponse> getPeople(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PEOPLE:
          serviceImpl.getPeople((az.etibarli.grpc.PersonRequest) request,
              (io.grpc.stub.StreamObserver<az.etibarli.grpc.PersonResponse>) responseObserver);
          break;
        default:
