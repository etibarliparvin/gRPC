...
public final class AgentServiceGrpc {
  ...
  public static final String SERVICE_NAME = "ticket.AgentService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.proto.agent.AgentRequest,
      com.proto.agent.AgentResponse> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = com.proto.agent.AgentRequest.class,
      responseType = com.proto.agent.AgentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.agent.AgentRequest,
      com.proto.agent.AgentResponse> getSendMethod() {
    io.grpc.MethodDescriptor<com.proto.agent.AgentRequest, com.proto.agent.AgentResponse> getSendMethod;
    if ((getSendMethod = AgentServiceGrpc.getSendMethod) == null) {
      synchronized (AgentServiceGrpc.class) {
        if ((getSendMethod = AgentServiceGrpc.getSendMethod) == null) {
          AgentServiceGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<com.proto.agent.AgentRequest, com.proto.agent.AgentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.agent.AgentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.agent.AgentResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AgentServiceMethodDescriptorSupplier("send"))
              .build();
        }
      }
    }
  ...
  public static abstract class AgentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(com.proto.agent.AgentRequest request,
        io.grpc.stub.StreamObserver<com.proto.agent.AgentResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.proto.agent.AgentRequest,
                com.proto.agent.AgentResponse>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class AgentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AgentServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.agent.AgentResponse send(com.proto.agent.AgentRequest request) {
  ...
  public static final class AgentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AgentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.agent.AgentResponse> send(
        com.proto.agent.AgentRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((com.proto.agent.AgentRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.agent.AgentResponse>) responseObserver);
          break;
        default:
