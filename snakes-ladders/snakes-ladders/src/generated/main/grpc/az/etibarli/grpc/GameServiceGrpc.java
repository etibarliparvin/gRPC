...
public final class GameServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<az.etibarli.grpc.Die,
      az.etibarli.grpc.GameState> getRollMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "roll",
      requestType = az.etibarli.grpc.Die.class,
      responseType = az.etibarli.grpc.GameState.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<az.etibarli.grpc.Die,
      az.etibarli.grpc.GameState> getRollMethod() {
    io.grpc.MethodDescriptor<az.etibarli.grpc.Die, az.etibarli.grpc.GameState> getRollMethod;
      ...
      synchronized (GameServiceGrpc.class) {
        if ((getRollMethod = GameServiceGrpc.getRollMethod) == null) {
          GameServiceGrpc.getRollMethod = getRollMethod =
              io.grpc.MethodDescriptor.<az.etibarli.grpc.Die, az.etibarli.grpc.GameState>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "roll"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.Die.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.GameState.getDefaultInstance()))
  ...
  public static abstract class GameServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<az.etibarli.grpc.Die> roll(
        io.grpc.stub.StreamObserver<az.etibarli.grpc.GameState> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                az.etibarli.grpc.Die,
                az.etibarli.grpc.GameState>(
                  this, METHODID_ROLL)))
          .build();
    }
  }
  ...
  private static abstract class GameServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return az.etibarli.grpc.BankService.getDescriptor();
    }
