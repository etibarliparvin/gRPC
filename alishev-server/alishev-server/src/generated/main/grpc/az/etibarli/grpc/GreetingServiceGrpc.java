...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc/GreetingService.proto")
public final class GreetingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<az.etibarli.grpc.HelloRequest,
      az.etibarli.grpc.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = az.etibarli.grpc.HelloRequest.class,
      responseType = az.etibarli.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<az.etibarli.grpc.HelloRequest,
      az.etibarli.grpc.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<az.etibarli.grpc.HelloRequest, az.etibarli.grpc.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<az.etibarli.grpc.HelloRequest, az.etibarli.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(az.etibarli.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<az.etibarli.grpc.HelloResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                az.etibarli.grpc.HelloRequest,
                az.etibarli.grpc.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public az.etibarli.grpc.HelloResponse greeting(az.etibarli.grpc.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<az.etibarli.grpc.HelloResponse> greeting(
        az.etibarli.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((az.etibarli.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<az.etibarli.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return az.etibarli.grpc.GreetingServiceOuterClass.getDescriptor();
    }
