...
@javax.annotation.Generated(
    ...
    comments = "Source: agent2/agent2.proto")
public final class AgentServiceGrpc {

  private AgentServiceGrpc() {}

  public static final String SERVICE_NAME = "agent2.AgentService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.proto.agent2.AgentRequest,
      com.proto.agent2.AgentResponse> getGetCountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getCount",
      requestType = com.proto.agent2.AgentRequest.class,
      responseType = com.proto.agent2.AgentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.proto.agent2.AgentRequest,
      com.proto.agent2.AgentResponse> getGetCountMethod() {
    io.grpc.MethodDescriptor<com.proto.agent2.AgentRequest, com.proto.agent2.AgentResponse> getGetCountMethod;
      ...
      synchronized (AgentServiceGrpc.class) {
        if ((getGetCountMethod = AgentServiceGrpc.getGetCountMethod) == null) {
          AgentServiceGrpc.getGetCountMethod = getGetCountMethod =
              io.grpc.MethodDescriptor.<com.proto.agent2.AgentRequest, com.proto.agent2.AgentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getCount"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.agent2.AgentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.agent2.AgentResponse.getDefaultInstance()))
  ...
  public static abstract class AgentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCount(com.proto.agent2.AgentRequest request,
        io.grpc.stub.StreamObserver<com.proto.agent2.AgentResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.proto.agent2.AgentRequest,
                com.proto.agent2.AgentResponse>(
  ...
  public static final class AgentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AgentServiceBlockingStub> {
    ...
    /**
     */
    public com.proto.agent2.AgentResponse getCount(com.proto.agent2.AgentRequest request) {
  ...
  public static final class AgentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AgentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.proto.agent2.AgentResponse> getCount(
        com.proto.agent2.AgentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_COUNT:
          serviceImpl.getCount((com.proto.agent2.AgentRequest) request,
              (io.grpc.stub.StreamObserver<com.proto.agent2.AgentResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AgentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.agent2.Agent2.getDescriptor();
    }
