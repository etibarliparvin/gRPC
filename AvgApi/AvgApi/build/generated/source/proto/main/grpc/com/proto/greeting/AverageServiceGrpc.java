...
public final class AverageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.proto.greeting.AverageRequest,
      com.proto.greeting.AverageResponse> getCountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "count",
      requestType = com.proto.greeting.AverageRequest.class,
      responseType = com.proto.greeting.AverageResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.proto.greeting.AverageRequest,
      com.proto.greeting.AverageResponse> getCountMethod() {
    io.grpc.MethodDescriptor<com.proto.greeting.AverageRequest, com.proto.greeting.AverageResponse> getCountMethod;
      ...
      synchronized (AverageServiceGrpc.class) {
        if ((getCountMethod = AverageServiceGrpc.getCountMethod) == null) {
          AverageServiceGrpc.getCountMethod = getCountMethod =
              io.grpc.MethodDescriptor.<com.proto.greeting.AverageRequest, com.proto.greeting.AverageResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "count"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greeting.AverageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.proto.greeting.AverageResponse.getDefaultInstance()))
  ...
  public static abstract class AverageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.proto.greeting.AverageRequest> count(
        io.grpc.stub.StreamObserver<com.proto.greeting.AverageResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                com.proto.greeting.AverageRequest,
                com.proto.greeting.AverageResponse>(
                  this, METHODID_COUNT)))
          .build();
    }
  }
  ...
  private static abstract class AverageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.proto.greeting.Averaging.getDescriptor();
    }
